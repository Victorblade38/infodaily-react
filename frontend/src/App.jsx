...
function App() {
  ...
  return (
    <div className="min-h-screen min-w-screen flex flex-col gap-4 xl:gap-10 justify-center items-center bg-gray-300 dark:bg-gray-600 lg:bg-gradient-to-b lg:from-gray-300 lg:to-gray-600  lg:dark:bg-gradient-b-t  lg:dark:from-gray-600  lg:dark:to-gray-800">
      <div className="p-2">
